        ...
        <v-row justify="center">
            <v-card  class="my-4">
                <v-card-title>Lista de proyectos
                    <v-spacer />
                    <v-text-field prepend-icon="mdi-search" label="Buscar proyecto por nombre" v-model="filtro"></v-text-field>
                </v-card-title>
...
export default {
    ...
    data: () => ({
        headers: [
            ...
            {text: "Acciones", value: "action", filerable: false}
        ],
        filtro: "",
        proyectos: [
            {numero: 1, nombre:"proyecto 1", status: "activo"},
            {numero: 2, nombre:"proyecto 2", status: "activo"},
            {numero: 3, nombre:"proyecto 3", status: "activo"},
            {numero: 4, nombre:"proyecto 4", status: "activo"},
            {numero: 5, nombre:"proyecto 5", status: "activo"},
            {numero: 6, nombre:"proyecto 6", status: "inactivo"}
        ],
        loading: true,
        abrirLogin: false,
        open: false
